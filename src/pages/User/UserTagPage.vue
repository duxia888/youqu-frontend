...
<template>
  ...
  <div style="margin: 20px">
    <van-button block type="primary" @click="TagUpdateValue">完成</van-button>
  </div>
  <!--是否注销-->
  <van-dialog v-model:show="showPasswordDialog" title="是否确认修改标签" show-cancel-button @confirm="updateTag"
              @cancel="doQuitCancel">
  </van-dialog>
</template>
